    ...
    */
    ...
    _createHorizontalLine: function _createHorizontalLine() {
      ...
      var dragged = function dragged(d) {
        ...
        select(".horizontalLineText").attr("y", eventY <= 10 ? 0 : eventY > maxY ? maxY - 10 : eventY - 10).text(d3Format_1(".0f")(self._y.invert(eventY < 0 ? 0 : eventY > maxY ? maxY : eventY)) + " m");
...
var L_Control_Height = L.control.heightgraph;

module.exports = L_Control_Height;
